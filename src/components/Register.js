    ...
    <div>
      <div className='bg-gray p-10 border border-border'>
        ...
        <form onSubmit={handleUserRegister}>
          ...
          <input className='btn bg-primary border-primary text-sm font-normal rounded mt-4' type="submit" value="Register" />
        </form>
        ...
        <div className='mt-8'>
          Allready have an accout? <Link
            to='/login' className='font-semibold'>Please Login</Link>
        </div>
      </div>
    </div>
  );
