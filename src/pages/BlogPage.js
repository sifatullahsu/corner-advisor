    ...
    <div className='container py-10'>
      <div className='bg-gray max-w-2xl mx-auto border border-border'>
        ...
        <div className='px-5 py-10 md:p-10 border-b border-border'>
          ...
          <p className='text-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia ipsum porro inventore harum commodi provident vitae placeat soluta aspernatur sint atque magni odit dignissimos, error nemo, iste fugiat quam velit earum cumque voluptates et reiciendis nihil quasi? Soluta culpa, nesciunt aspernatur unde saepe, mollitia neque nihil quae doloribus, atque veniam!</p>
        </div>
        <div className='px-5 py-10 md:p-10 border-b border-border'>
